...
//			HttpServletResponse response) throws DataDuplicatedException,
...
//		Product product = new Product(productID, mallID, productName, company,
//				price1, price2, installment, keyword, detail, productDate,
//				photoDir);
//
...
//
//		// 3.3.4. RequestDispatcher 객체를 통해 뷰 서블릿(sucessProductAdd.jsp")으로 요청을
//		// 전달한다.
//		RequestDispatcher dispatcher = request
...
//		int mb = 20;
//		MultipartRequest mr = new MultipartRequest(request, upPath,
//				mb * 1024 * 1024, "utf-8");
//
//		// 3.1. 요청 파라미터를 통해 HTML 폼 데이터를 얻어낸다.
