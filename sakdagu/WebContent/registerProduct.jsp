				...
				<form action="product?action=register" method="POST">
					...
					<table class="registertable">
						...
						<tr>
							...
							<td><input type="text" name="mallID" size="20"
								maxlength="15"></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="price1" size="20"
								maxlength="20"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="radio" name="installment" value="1" checked>가능
								<input type="radio" name="installment" value="0">불가능</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="detail" size="50"
								maxlength="70"></td>
						</tr>
						<tr>
						...
						<tr>
							<td></td>
							<td><input type="submit" value="상품등록"> <input
